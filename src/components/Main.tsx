        ...
        <div className="col-span-1 flex flex-col gap-5 justify-start items-center py-3">
          ...
          <div className="flex gap-4">
            <a
              ...
              target="_blank"
              className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-sky-800 shadow-md shadow-sky-500 group transition-all duration-300"
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-green-600 shadow-md shadow-green-400 group transition-all duration-300"
            >
              <svg
                className="fill-gray-100 relative z-10 transition-all duration-300 group-hover:fill-black"
                xmlns="http://www.w3.org/2000/svg"
