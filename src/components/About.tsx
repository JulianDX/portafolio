...
export const About = ({ flagEs }: flagProp) => {
  return (
    <>
      <div className="relative h-full w-full about">
        <section
          id="sobremi"
          className="px-2 md:animate-fade-up md:animate-once md:animate-ease-in md:animate-normal pt-10 md:pt-16 p-10"
        >
          <div className="rounded-lg bg-black bg-opacity-70 max-w-4xl mx-auto p-6 md:p-8 text-gray-100 gap-5 md:shadow-[5px_5px_0px_0px_rgba(66,128,204)] border-2 border-sky-600">
