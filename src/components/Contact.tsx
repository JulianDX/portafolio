  ...
  return (
    ...
    >
      <h2
        ...
        className={` ${
          inViewTitle &&
          "md:animate-fade-down md:animate-delay-300 text-white text-4xl text-center drop-shadow-[0_2.2px_2.2px_rgba(189,0,255,1)]"
        }`}
      >
        Contacto
      </h2>
      <div
        ref={contentContact}
        className={`opacity-0 ${inViewContent && "opacity-100 md:animate-fade md:animate-delay-700"}`}
      >
