                ...
                >
                  {data?.map((project) => {
                    return (
                      <div
                        key={project.nombre}
                        className="z-20 max-w-sm bg-sky-950 border hover:scale-101 transition-transform duration-500 border-sky-500 rounded-lg shadow dark:bg-sky-950 bg-opacity-25 dark:border-sky-500"
                      >
                        <a href="#">
