                ...
                >
                  {data?.map((project) => {
                    return (
                      <div
                        key={project.nombre}
                        className="z-20 max-w-sm bg-white border hover:scale-101 transition-transform duration-500 border-gray-200 rounded-lg shadow dark:bg-sky-950 bg-opacity-10 dark:border-sky-500"
                      >
                        <a href="#">
